...
<div id="topHeader">
ANSHUMAN KUMAR<br />
    <span class="tag">STUDENT FEEDBACK SYSTEM 5</span>
</div>
<br>
<br>
<br>
<br>
<div id="content" align="center" class="red">
<br>
<br>
...
<div id="table">
	<div class="tr">
		<div class="td">
        	<label class="admin">Admin ID : </label>
        </div>
        <div class="td">
    ...
    <div class="tr">
        ...
        <!-- <div class="tdd generateButton">
        	<input type="submit" value="Login" />
        </div> -->
        <button type="submit" value="login" class="generateButton">login</button>
    <br>
</form>
</div>
